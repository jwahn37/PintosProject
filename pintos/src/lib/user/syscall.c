...
add a new syscall4 function which has 4 parameters */
...
//fibonacci system call by jinu
int 
fibonacci (int n)
{
	return syscall1 (SYS_FIBONACCI, n);
}
//sum system call by jinu
int
sum_of_four_integers (int a, int b, int c, int d)
{
	return syscall4 (SYS_SUM_FOUR_INT, a, b, c, d);
}
